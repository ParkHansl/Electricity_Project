...
# def build_cnn_lstm_model(sequence_shape, static_shape):
#     """CNN-LSTM 모델"""
#     sequence_input = Input(shape=sequence_shape, name='sequence_input')
    
#     conv1 = Conv1D(filters=64, kernel_size=3, activation='relu', padding='same')(sequence_input)
...
#     lstm1 = LSTM(64, return_sequences=True, dropout=0.2)(conv2)
#     lstm2 = LSTM(32, dropout=0.2)(lstm1)
